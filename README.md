...
[![Platform](https://img.shields.io/badge/■_Platform-Win│Linux-4DB6AC?style=for-the-badge&logo=linux&logoColor=ffffff&labelColor=1A1A2E)](https://github.com/HyperSecurityLabs/OxideCE-v7.9.1ELITE)
...
[![Warning](https://img.shields.io/badge/Authorized-Testing-ff1744?style=for-the-badge&logo=electron&logoColor=ffffff&labelColor=4A0000)](https://github.com/HyperSecurityLabs/OxideCE-v7.9.1ELITE)
...
[![About](https://img.shields.io/badge/◈_About-OXIDE-557C94?style=for-the-badge&logo=github&logoColor=ffffff&labelColor=1B2A38)](https://github.com/HyperSecurityLabs/OxideCE-v7.9.1ELITE)
...
[![ML](https://img.shields.io/badge/◇_ML_Stack-7E57C2?style=for-the-badge&labelColor=311B92)](https://github.com/HyperSecurityLabs/OxideCE-v7.9.1ELITE)
[![Reports](https://img.shields.io/badge/▣_Reports_Multi-FF7043?style=for-the-badge&labelColor=BF360C)](https://github.com/HyperSecurityLabs/OxideCE-v7.9.1ELITE)
[![Transport](https://img.shields.io/badge/→_reqwest-42A5F5?style=for-the-badge&labelColor=0D47A1)](https://github.com/HyperSecurityLabs/OxideCE-v7.9.1ELITE)
...
[![Installation](https://img.shields.io/badge/⌨_Installation-Quick_Start-00d4ff?style=for-the-badge&logo=terminal&logoColor=ffffff&labelColor=004D40)](https://github.com/HyperSecurityLabs/OxideCE-v7.9.1ELITE)
...
git clone https://github.com/HyperSecurityLabs/OxideCE-v7.9.1ELITE.git
cd OxideCE-v7.9.1ELITE && cargo build --release
sudo cp target/release/oxide /usr/local/bin/

oxide --version   # → oxide 7.9.1-elite
```
...
[![Usage](https://img.shields.io/badge/⊞_Usage-Reference-b388ff?style=for-the-badge&logo=terminal&logoColor=ffffff&labelColor=311B92)](https://github.com/HyperSecurityLabs/OxideCE-v7.9.1ELITE)
...
[![Scanner Modules](https://img.shields.io/badge/▤_Scanner_Modules-13_Engines-00e676?style=for-the-badge&logo=github&logoColor=ffffff&labelColor=004D40)](https://github.com/HyperSecurityLabs/OxideCE-v7.9.1ELITE)
...
[![Zero-Day ML](https://img.shields.io/badge/◉_Zero--Day_ML-Anomaly_Engine-ff6b6b?style=for-the-badge&logo=smart&logoColor=ffffff&labelColor=8B0000)](https://github.com/HyperSecurityLabs/OxideCE-v7.9.1ELITE)
...
[![Advanced](https://img.shields.io/badge/⊡_Advanced-Capabilities-00d4ff?style=for-the-badge&logo=github&logoColor=ffffff&labelColor=006064)](https://github.com/HyperSecurityLabs/OxideCE-v7.9.1ELITE)
...
- **Target URL input** — enter targets directly in the GUI
- **Scan presets** — Quick, Full, Stealth, Zero-Day, Recon — each with pre-configured module sets
- **Configuration panel** — accordion groups for Performance, Scan, Network, Modules, Output, Advanced
- **Module selection chips** — toggle individual scan modules on/off
- **Toggle switches** — enable/disable features like headless crawling, zero-day ML, session hijacking
- **Live terminal console** — real-time stdout/stderr streaming from the `oxide` child process (ANSI-stripped)
- **Status badge** — current scan state (idle, running, completed, failed)
- **About modal** — version info, credits, links
...
sudo cp target/release/oxide-gui /usr/local/bin/
oxide-gui
```
...
[![CLI Reference](https://img.shields.io/badge/⌘_CLI-Full_Reference-557C94?style=for-the-badge&logo=terminal&logoColor=ffffff&labelColor=1B2A38)](https://github.com/HyperSecurityLabs/OxideCE-v7.9.1ELITE)
...
[![Reports](https://img.shields.io/badge/▥_Reports-Formats-b388ff?style=for-the-badge&logo=github&logoColor=ffffff&labelColor=311B92)](https://github.com/HyperSecurityLabs/OxideCE-v7.9.1ELITE)
...
[![Changelog](https://img.shields.io/badge/☰_Changelog-v7.9.1--elite-00e676?style=for-the-badge&logo=github&logoColor=ffffff&labelColor=004D40)](https://github.com/HyperSecurityLabs/OxideCE-v7.9.1ELITE/releases)
...
[![Build](https://img.shields.io/badge/⚙_Build-Release-00d4ff?style=for-the-badge&logo=rust&logoColor=ffffff&labelColor=006064)](https://github.com/HyperSecurityLabs/OxideCE-v7.9.1ELITE)
...
[![Issues](https://img.shields.io/badge/⊗_Report_Bugs-ff6b6b?style=for-the-badge&logo=bugatti&logoColor=ffffff&labelColor=8B0000)](https://github.com/HyperSecurityLabs/OxideCE-v7.9.1ELITE/issues)
...
[![Development](https://img.shields.io/badge/❖_Development-Community_Driven-00d4ff?style=for-the-badge&logo=github&logoColor=ffffff&labelColor=006064)](https://github.com/HyperSecurityLabs/OxideCE-v7.9.1ELITE)
...
```
Latest:   v7.9.1-elite — ML engine, fuzzing, WAF bypass, headless JS
Next:     Shaped by you → open issues, feature requests, PRs
Vision:   apt install oxide on Kali Linux
```

[![Issues](https://img.shields.io/badge/⊘_Request_Feature-ff6b6b?style=for-the-badge&logo=bugatti&logoColor=ffffff&labelColor=8B0000)](https://github.com/HyperSecurityLabs/OxideCE-v7.9.1ELITE/issues)
...
[![Star](https://img.shields.io/badge/★_Star_on_GitHub-Support-58A6FF?style=for-the-badge&logo=github&logoColor=000000&labelColor=0D1117)](https://github.com/HyperSecurityLabs/OxideCE-v7.9.1ELITE)
[![Website](https://img.shields.io/badge/▲_Website-HyperSec-00E676?style=for-the-badge&logo=google-chrome&logoColor=000000&labelColor=005B47)](https://hypersecurityoffensivelabs-about.is-best.net/)

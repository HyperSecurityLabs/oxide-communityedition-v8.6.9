...
#[command(name = "oxide")]
#[command(author, version = "7.9.1-elite", about = "OXIDE Elite Community Edition — Open eXtensible Intelligence & Detection Engine", long_about = None)]
pub struct CliArgs {
    ...
    #[arg(short, long, help = "Number of concurrent worker threads for scanning.
                    ...
                    \x1B[38;2;0;180;120m\x1B[3mUsage: --threads 50\x1B[0m", default_value_t = 20)]
    pub threads: usize,
    ...
    #[arg(long, help = "Scan intensity level from 1 (gentle) to 100 (aggressive).
                    ...
                    \x1B[38;2;0;180;120m\x1B[3mUsage: --exploitation-level 75\x1B[0m", default_value_t = 50)]
    ...
    #[arg(long, help = "Maximum number of payloads to send per test case.
                    ...
                    \x1B[38;2;0;180;120m\x1B[3mUsage: --payload-limit 100\x1B[0m", default_value_t = 50)]

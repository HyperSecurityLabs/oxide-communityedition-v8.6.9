...
<div class="container">
    <div class="header">
        ...
        <div class="subtitle">Community Edition &nbsp;|&nbsp; Zero-Day Intelligence & Detection Engine</div>
        <div class="version">v8.5.0community-edition  //  hypersecurity_offsec</div>
    </div>
    <div class="meta-grid">
        <div class="meta-card">
...
<table>
    ...
    pub fn generate_footer() -> String {
        r#"
    <footer>
        <p>Generated by OXIDE Community Edition v8.5.0community-edition</p>
        <div class="glitch">// hypersecurity_offsec // kali linux community //</div>
    </footer>
</div>
</body>
</html>"#

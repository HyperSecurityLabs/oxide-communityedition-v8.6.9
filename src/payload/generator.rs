...
// ----------------------------------------------------------------------------
//  Payload generator — creates tailored payloads based on detected technologies.
//
//  --- Developers ---------------------------------------------------------------
...
//  PayloadGenerator: テクノロジー認識型ペイロード生成器
//  Generates target-aware payloads based on common web technologies.
//  生成戦略:
//   - generate_paths — 既知の機密パス/エンドポイントのブルートフォース
//   - generate_params — 一般的なパラメータ名 + インジェクション値
//   - generate_headers — HTTPヘッダーインジェクション・バイパスベクトル
//  拡張性: 新しいテクノロジー電脳検出時にベクター追加可能
